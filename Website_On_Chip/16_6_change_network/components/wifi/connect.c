...
static esp_netif_t * gp_wifi = NULL;
...
wifi_connect_sta (const char * p_ssid, const char * p_pass, int32_t timeout)
{
    ...
    gp_wifi = esp_netif_create_default_wifi_sta();
...
wifi_connect_ap (const char * p_ssid, const char * p_pass)
{
    ...
    gp_wifi = esp_netif_create_default_wifi_ap();
...
void
wifi_destroy_net (void)
{
    esp_netif_destroy(gp_wifi);
}